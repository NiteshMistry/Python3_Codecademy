...
daily_transactions_split = [d.split('-') for d in daily_transactions]
#print(daily_transactions_split)

transactions_clean = []
for d in daily_transactions_split:
  temp = []
  for i in d:
    temp.append(i.strip())
...
for c, s, t, _ in transactions_clean:
  customers.append(c)
  sales.append(s)
...
for c in colors:
  print('Sold {} threads of {} '.format(color_count(c),c))
